export declare function initGithub(token: string): void;
export declare function getUserRepos(token: string): Promise<{
    id: number;
    node_id: string;
    name: string;
    full_name: string;
...
export declare function getRepoFile(token: string, owner: string, repo: string, path: string): Promise<string | null>;
export declare function createPullRequest(token: string, owner: string, repo: string, branchName: string, title: string, body: string, files: {
    path: string;
    content: string;
}[]): Promise<{
    url: string;
